...
export const categories: Category[] = [
  ...
  },
  {
    ...
    icon: '⚽',
    color: '#10b981',
    subcategories: ['Equipment', 'Clothing', 'Shoes', 'Supplements', 'Accessories'],
  },
  {
    id: 6,
    name: 'Books',
...
export const productReviews: Review[] = [
  {
    ...
    rating: 5,
    date: '2 days ago',
    comment: 'Absolutely love these earbuds! Sound quality is amazing and battery life is incredible.',
  },
  {
    id: 2,
    user: 'James K.',
    ...
    rating: 4,
    date: '1 week ago',
    comment: 'Great value for money. Comfortable fit and good noise cancellation.',
  },
  {
    id: 3,
    user: 'Emily R.',
