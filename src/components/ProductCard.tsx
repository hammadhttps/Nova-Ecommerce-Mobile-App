    ...
    >
      <View style={styles.imageContainer}>
        ...
        {comparisonMode && (
          ...
          >
            <Scale
              size={16}
              color={isSelectedForComparison ? '#ffffff' : isDark ? '#d4d4d4' : '#525252'}
            />
          </TouchableOpacity>
        )}
        {!comparisonMode && (
          ...
          >
            <Heart
              size={18}
              color={isInWishlist ? '#d4183d' : isDark ? '#d4d4d4' : '#525252'}
      ...
      <View style={styles.content}>
        ...
        <View style={styles.ratingContainer}>
          ...
          <Text style={[styles.rating, { color: isDark ? '#a3a3a3' : '#737373' }]}>
            {formatRating(product.rating)}
          </Text>
        </View>
        <View style={styles.priceContainer}>
          <Text style={[styles.price, { color: isDark ? '#fafafa' : '#030213' }]}>
